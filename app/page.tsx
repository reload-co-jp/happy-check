    ...
    <>
      ...
      <section className="section-shell about" id="about">
        <div className="section-heading">
          ...
          <h2>概要と日常ログで違いをつかむためのサイトです</h2>
        </div>
        <div className="about-grid">
          <p>
            このサイトは、専門知識がなくても「幸せホルモン」という言葉の背景を理解しやすいよう、
            4つの物質の概要、違い、注意点を整理しています。
          </p>
          <p>
            セロトニン、ドーパミン、オキシトシン、エンドルフィンには個別ページを用意し、
            分泌量の診断ではなく、日常の状態を定性的に振り返る観察ポイントを紹介しています。
          </p>
          <p>
            運営会社は Reload, Inc.
            です。一般向けに読みやすく整理しながら、医療的な断定を避けた情報提供を目指しています。
          </p>
          <p>
            会社情報は
            <a className="inline-link" href="https://reload.co.jp/">
              Reload, Inc. 公式サイト
            </a>
            からご確認いただけます。
          </p>
